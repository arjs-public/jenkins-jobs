...
import net.arjs.jobs.cictl.DslMavenJobBase
import spock.lang.Specification

class TestDslMavenJobBaseSpec extends Specification {

    JobParent jobParent = JobParentMixin.createJobParent()
    DslMavenJobBase base = null

    def setup() {
        base = new DslMavenJobBase(
                name: "Test",
    ...
    def "test getDisabled"() {
        given:
        base

        when:
        Boolean flag = base.getDisabled()

        then:
        !flag
    }

    def "test setDisabled"() {
        given:
        base
